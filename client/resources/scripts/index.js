...
function handleEditClick(){
    makeEditable();
    hideButtons();
    var buttonHtml = "<button class=\"btn btn-primary btn-1g\" onclick=\"handleEditSave("+myBook.id+")\">Save</button>";
    buttonHtml += "<button class=\"btn btn-warning btn-1g btn-cancel\" onclick=\"handleCancelSave()\">Cancel</button>";
...
function handleNewClick(){
    ...
    hideButtons();
    blankFields();
    var buttonHtml = "<button class =\"btn btn-primary btn-1g\" onclick=\"handleNewSave()\">Save</button>";
    buttonHtml += "<button class=\"btn btn-warning btn-1g btn-cancel\" onclick=\"handleCancelSave()\">Cancel</button>";
    document.getElementById("saveButton").innerHTML = buttonHtml;
    document.getElementById("saveButton").style.display = "inline-block";
}
function handleRentClick(){
    myBooks.numAvlb--;
    document.getElementById("bookAvlb").value = numAvlb;
    putBook(myBook.id);
}
